...
The residuals vs fitted plot looks to be highly violated, the variance is not constant at all. The Q-Q Plot looks to be mostly fine except for point 22 that is an outlier. Since these two diagnostic plots are both violated, we will run a levene test to double check.
